...
import { AccountBuyCourse, AccountChangeProfile, AccountCheckPayment } from '@student-helper/contracts';
...
export class UserCommands {
	constructor(private readonly userRepository: UserRepository, private readonly rmaService: RMQService) { }
	...
	async buyCourse(@Body() { userId, courseId }: AccountBuyCourse.Request): Promise<AccountBuyCourse.Response> {
		...
		const saga = new BuyCourseSaga(userEntity, courseId, this.rmaService);
